...
class ItemsCache {
    ...
    //private itemsCache: {[key:string]: IItem}  //anonymous interface
...
const item1 = cache.createItem('a string');
const item2 = cache.createItem('b string');
const item3 = cache.createItem('a string');
